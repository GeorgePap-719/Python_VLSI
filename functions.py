...
def parser():    
    ...
    for i in range(len(lines)):
        ...
        if tempParsing.find("NUMTERMINALS") != -1:
            ...
            saved = i + 1 #Starting point for the 2nd for, +1 for the next line.
            break
    ...
    for j in range(saved,len(lines)):
        ...
        if len(temp) == 3:              #len == 3 -> Non Terminal
            ...
            print("Error. File is modified!") #Length isnt 3 or 4 - Modified file
    ...
    for i in range(len(lines)):
        ...
        if tempParsing.find("COREROW HORIZONTAL") != -1:
            ...
            if temp.find("COORDINATE") != -1:
                ...
                rowCoord = int(rowCoord)    #Lower Left Corner y coordinate of the row
            ...
            newRow = Row(rowName, rowCoord, (rowHeight+rowCoord), rowSub, numSites)
